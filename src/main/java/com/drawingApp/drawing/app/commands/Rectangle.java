...
/**
 * Command to draw Rectangle in the Canvas.
 */
public class Rectangle implements Command {
    ...
    public Rectangle(int x1, int y1, int x2, int y2, InMemoryCanvasRepository inMemoryCanvasRepository) {
        this.x1 = x1;
        this.y1 = y1;
        this.x2 = x2;
        this.y2 = y2;
    ...
    public void execute() throws InvalidInputException {
        inMemoryCanvasRepository.drawRectangle(x1, y1, x2, y2);
    }
}
